...
const caixaAlternativas= document.querySelector(caixa-lternativas)
const caixaResultado= document. querySelector(caixa-Resultado)
const textoResultado= document.querySelector (texto-resultado)

const perguntas=[
{
        enunciado: "Assim que saiu da escola, voce se depara com uma nova tecnologia:um chat que",
        alternativas:[
              "isso é maravilhoso",
              "isso é assustador"
        ]
...
caixaPerguntas.textcontent=oerguntaAtual.enunciado;
mostraAlternativa();
}
